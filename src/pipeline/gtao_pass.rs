...
pub struct GtaoPass {
    ...
    pub raw_bent_normal_texture: wgpu::Texture,
    pub raw_bent_normal_view: wgpu::TextureView,
    pub blurred_bent_normal_texture: wgpu::Texture,
    pub blurred_bent_normal_view: wgpu::TextureView,
